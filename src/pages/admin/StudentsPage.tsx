...
const StudentsPage = () => {
  ...
  const handleSubmit = () => {
    if (!formData.rollNumber || !formData.name || !formData.email || !formData.department || !formData.year || !formData.mobile) {
    ...
    setFormData({ rollNumber: "", name: "", email: "", department: "", year: "", mobile: "" });
